...
class Message extends Base {
  constructor(data, client) {
    ...
    this.member = this.channel.guild && this.sender.id ? this.channel.guild.member(this.sender.id) || this.channel.guild.members.set(this.sender.id, new Member(data.member)) : null;
